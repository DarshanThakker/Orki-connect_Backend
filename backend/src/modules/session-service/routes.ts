...
router.post('/public/sessions', async (req: any, res: Response, next: NextFunction) => {
  try {
...
router.post('/sessions/refresh', async (req: any, res: Response, next: NextFunction) => {
  try {
...
router.post('/sessions/:session_id/transactions', sessionAuthMiddleware, async (req: any, res: Response, next: NextFunction) => {
  try {
