 ...
 */
export declare function getOrgByClientId(client_id: string): Promise<Organization | null>;
/**
 ...
 */
export declare function updateOrgConfig(organization_id: string, updates: any): Promise<any>;
